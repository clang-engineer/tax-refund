...
public class RefundServiceUnitTest {
    ...
    void testGetLimitedMoneyLower() {
        assertThat(refundService.getLimitedMoney(Constants.REFUND_LOWER_LIMIT)).isEqualTo(740000);
        assertThat(refundService.getLimitedMoney(Constants.REFUND_LOWER_LIMIT - 1)).isEqualTo(740000);
        assertThat(refundService.getLimitedMoney(Constants.REFUND_LOWER_LIMIT + 1)).isNotEqualTo(740000);
    }
